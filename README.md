...
After training, please use [**CREPE**](https://github.com/marl/crepe) to extract the F0 from both the generated audio and the source audio ([NUS48E vocal recordings](https://drive.google.com/file/d/1EQ_N8Vvp3j4VHp5qZRWgLdtBIYJEsdGV/view?usp=sharing)).
