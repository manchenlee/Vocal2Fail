...
Both the generator and discriminator were optimized using the Adam optimizer with a learning rate of η=10−4. The model was trained for 100 epochs with a batch size of 4.
...
**Objective Metrics**  
This code computes Pitch Class L1, DTW distance and HNR. We employed Type II (d) from the Rabiner-Myers step patterns for the DTW computation
